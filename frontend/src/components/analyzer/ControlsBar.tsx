    ...
    return (
        <header
            ...
            className={cn(
                ...
                !isPinned && !isVisible ? "-translate-y-[calc(100%-4px)] opacity-0 hover:opacity-100" : "translate-y-0 opacity-100"
            )}
        >
            ...
            <div className="container max-w-[1600px] mx-auto flex h-14 items-center gap-6 px-6">
                ...
                <div className="flex items-center gap-4">
                    ...
                    >
                        <TabsList className="h-8 bg-slate-100 dark:bg-slate-800 p-0.5">
                            <TabsTrigger value="quarterly" className="h-7 text-xs px-3">Quarterly</TabsTrigger>
                            <TabsTrigger value="annual" className="h-7 text-xs px-3">Annual</TabsTrigger>
                        </TabsList>
                    </Tabs>

                    <div className="flex items-center gap-2">
                        <span className="text-[10px] font-semibold uppercase tracking-wider text-slate-400 dark:text-slate-500">Periods</span>
                        <Select
                ...
                <div className="flex items-center gap-2 flex-1 justify-end">
                    ...
                    >
                        {isPinned ? <PinOff className="h-4 w-4 fill-current" /> : <Pin className="h-4 w-4" />}
                    </Button>
                </div>
            </div>
        </header>
