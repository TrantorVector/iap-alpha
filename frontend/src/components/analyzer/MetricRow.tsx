...
import { calculateHeatMapColor, getHeatMapOpacity, getHeatMapTextColor, HeatMapConfig } from '@/lib/heatmap';
 ...
 */
export function MetricRow({ label, values, invertColors = false, formatter = defaultFormatter }: MetricRowProps) {
